...
export const TopNavbar = () => {
  return (
    <div className="flex text-white h-12">
      <div className="bg-gray-800 w-56 flex-none px-3 py-2 flex justify-between border-b border-gray-900">
      ...
      <div className="bg-gray-750 flex-1 flex items-center justify-between px-4 border-b border-gray-900">
