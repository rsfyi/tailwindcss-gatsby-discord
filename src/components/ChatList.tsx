...
export const ChatList = () => {
  return (
    <div className="bg-gray-750 flex-1 flex flex-col justify-between">
      ...
      <div className="bg-gray-750 flex items-center mx-3 h-24 border-t border-gray-600">
        <button className="p-2 h-10 bg-gray-700 rounded-l text-gray-500 hover:text-white border-r border-gray-600">
        ...
        <div className="flex-1">
          <input
            type="text"
            className="w-full text-sm h-10 px-2 py-2 bg-gray-700 focus:outline-none text-gray-200"
          />
        </div>
